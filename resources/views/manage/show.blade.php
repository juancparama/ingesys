            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li>
                            <button type="button" class="d-flex justify-content-center align-items-center btn btn-sm btn-outline-dark cerrable" @if ($ticket->status==2) disabled @endif onclick="window.location.href='{{URL::route('manage.edit',$ticket->id) }}'">
