            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="mx-1">
                            <button type="button" class="d-flex justify-content-center align-items-center btn btn-primary btn-sm" onclick="window.location.href='{{ route('ticket.edit', $ticket->id) }}'" @if ($ticket->status!=0) disabled @endif >
                        ...
                        <li class="mx-1">
                            <form action="{{route('ticket.destroy', $ticket->id)}}" method="POST" class="@if ($ticket->status==0) form-sa-delete @endif">
                              @csrf
                              @method('DELETE')
                              <button type="submit" class="d-flex justify-content-center align-items-center btn btn-primary btn-sm" @if ($ticket->status!=0) disabled @endif >
