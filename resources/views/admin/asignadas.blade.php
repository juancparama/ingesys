            ...
            <div class="secondarynav bg-light mb-4 flex-center border-bottom" style="min-height: 48px">
                <div class="container py-1">
                    <div class="d-flex flex-row flex-wrap">
                        <a class="btn btn-secondarynav shadow-none active" href="{{route('admin.incidencias')}}">Todas</a>
                        <a class="btn btn-secondarynav shadow-none " href="{{route('admin.pendientes')}}">Pendientes</a>
                        <a class="btn btn-secondarynav btn-primary shadow-none " href="{{route('admin.asignadas')}}">Asignadas</a>
...
<table id="tabla" class="table " style="width:100%">
    <thead>
        <tr>
            ...
            <th class="col-1" ata-priority="1">Acción</th>
        </tr>
    </thead>
      ...
      <tr>
          ...
          <td>
                <div class="d-flex">
                  ...
                  @if ($ticket->status==0)
                    <a href="{{ $ticket->id }}/edit" type="button" class="d-flex justify-content-center align-items-center btn btn-sm ms-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"></path>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"></path>
                        </svg>
                        <span class="text-sm ms-2">Editar</span>
                    </a>

                    <form action="{{route('admin.destroy', $ticket->id)}}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="d-flex justify-content-center align-items-center btn btn-sm ms-1">
  ...
  @else
  <h2 class="text-center text-secondary p-4">Ninguna incidencia asignada</h2>
@endif
