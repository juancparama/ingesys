            ...
            <div class="secondarynav bg-light mb-4 flex-center border-bottom" style="min-height: 48px">
                <div class="container py-1">
                    <div class="d-flex flex-row flex-wrap">
                        ...
                        <a class="btn btn-secondarynav btn-primary shadow-none " href="{{route('admin.completadas')}}">Completadas</a>
                    </div>
                </div>
            </div>
...
<table id="tabla" class="table " style="width:100%">
    ...
    <thead>
        <tr>
            ...
            <th class="col-2" data-priority="3">Cerrada</th>
    ...
    <tbody>
      ...
      <tr>
          ...
          <td class="text-lg">
            @if ($ticket->type_id==1)
                <span class="fw-italic px-2 badge bg-danger rounded-pill align-text-top">Avería</span>
            @elseif ($ticket->type_id==2)
                <span class="fw-light px-2 badge bg-info rounded-pill align-text-top">Evaluación</span>
            @else
                <span class="px-2 badge bg-secondary rounded-pill align-text-top">Sin asignar</span>
            @endif
          </td>

          <td class="p-2"><span class="d-block">{{\Carbon\Carbon::parse($ticket->closed_at)->diffForHumans() }}</span></td>
          <td class="p-2">
              <div class="d-flex">
